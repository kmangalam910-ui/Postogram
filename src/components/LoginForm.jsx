...
const LoginForm = ({showLoginSection, loginDetails }) => {
    return <div className={`bg-info ${showLoginSection} rounded-5 fixed right-10 top-20`}>
        <StyledWrapper>
            <div className="container">
                <div className="heading text-info flex justify-between">
                    <span>Sign In</span>
                    <span onClick={() => loginDetails('hidden')} className='mt-2 hover:cursor-pointer'><IoClose/></span></div>
                <form className="form">
